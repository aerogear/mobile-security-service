...
| `make docker-build`           | Compile a binary and create a Docker image from it.
| `make docker-build-release`   | Compile a binary and create a Docker image with a release tag
| `make docker-build-master`    | Compile a binary and create a Docker image tagged `master`
...
| `make docker-push-release`    | Pushes release image to Docker image hosting repository
| `make docker-push-master`     | Pushes master image to Docker image hosting repository
