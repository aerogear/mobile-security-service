...
func (a *appsService) InitClientApp(sdkInfo *models.Device) (*models.Version, error) {
	...
	if hasVersion && !hasDeviceVersion {
		if err := a.createOrUpdateDevice(hasAnyOtherVersion, deviceDiffVersion, version, sdkInfo, app); err != nil {
			return nil, err
		}
...
func (a *appsService) createOrUpdateDevice(hasAnyOtherVersion bool, deviceDiffVersion *models.Device, version *models.Version, sdkInfo *models.Device, app *models.App) error {
	device := models.NewDevice(sdkInfo, app, version)
	if hasAnyOtherVersion {
		if err := a.repository.UpdateDeviceVersion(deviceDiffVersion, version); err != nil {
			return err
		}
	} else {
		if err := a.repository.CreateNewDevice(device); err != nil {
			return err
		}
	}
	return nil
