...
func (a *appsService) BindingAppByApp(appId, name string) error {
	...
	if err != nil && err == models.ErrNotFound {
		return a.repository.CreateApp(models.NewApp(appId, name))
	}
...
func (a *appsService) InitClientApp(sdkInfo *models.Device) (*models.Version, error) {
	...
	if !hasVersion && !hasDeviceVersion {
		if err = a.handleNewVersionAndInstall(sdkInfo, deviceDiffVersion, hasAnyOtherVersion); err != nil {
			return nil, err
		}
	}
	...
	if !hasVersion && !hasDeviceVersion && !hasApp {
		...
		models.NewAppByDevice(sdkInfo)
		if err = a.repository.CreateApp(models.NewAppByDevice(sdkInfo)); err != nil {
			return nil, err
		}
		if err = a.handleNewVersionAndInstall(sdkInfo, deviceDiffVersion, hasAnyOtherVersion); err != nil {
			return nil, err
...
func (a *appsService) handleNewVersionAndInstall(sdkInfo, deviceDiffVersion *models.Device, hasAnyOtherVersion bool) error {
	version := models.NewVersionByDevice(sdkInfo)
