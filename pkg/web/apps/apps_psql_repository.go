...
func (a *appsPostgreSQLRepository) CreateApp(app *models.App) error {

	// Update Version
	_, err := a.db.Exec(`INSERT INTO app (id, app_id, app_name) VALUES ($1,$2,$3)`, app.ID, app.AppID, app.AppName)
